...
Вданном разделе описывается план тестирования приложения "TasksAndProjectsManager". Раздел предназначен для людей, выполняющих тестирование данного проекта. Цель тестирования - проверка соответствия реального поведения программы проекта и ее ожидаемого поведения.
...
|004-1: Установка сроков|Установить срок выполнения|Сохранение срока|Сроки устанавливаются|Тест пройден|
